...
$idx = $_GET['idx'];
    ...
    if($s_name == $res_check['writer']){
        echo "<script>alert('자신의 게시글입니다!');";
        echo "window.history.back()</script>";
        exit;
    }

    $sql_check2 = "SELECT * FROM like_ok WHERE like_post_id='$idx' and like_user='$s_name'";
    ...
    INSERT INTO like_ok(like_post_id, like_user) VALUES ('$idx', '$s_name');
    ";
